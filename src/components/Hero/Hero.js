  ...
  return (
    <div className={styles.heroContainer}>
      ...
      <p className={styles.title}>
        <b>Zero Swaps</b> on All <br /> XM Ultra Low Accounts for more than 25
        instruments!
      </p>
      <p className={styles.infoText}>
        Enjoy spreads <b>as low as 0.6 pips</b> and <b>leverage up to 1000:1</b>
        on instruments like <b>EURUSD, USDJPY, EURJPY, GBPUSD</b>, and
        <b>Gold</b>.
      </p>
